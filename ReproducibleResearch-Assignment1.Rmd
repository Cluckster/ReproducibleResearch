...
```{r }
intervalSteps <- aggregate(steps ~ interval, extractedData, mean)
plot(intervalSteps$interval, intervalSteps$steps, type="l", main = "Average Steps per Day by Interval",xlab = "Interval", ylab = "Number of Steps")
```
